"""METASCRUB core — Strip identifying metadata from docs/images before release."""
...
RULES = [
    ("MET-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("MET-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("MET-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
