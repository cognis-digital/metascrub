...
import argparse, sys
from metascrub.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="metascrub", description="METASCRUB — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from metascrub.mcp_server import serve
        return serve()
    if args.cmd == "scan":
