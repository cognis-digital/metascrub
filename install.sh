#!/usr/bin/env sh
# Universal installer for metascrub. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/metascrub.git"
echo "Installing metascrub ..."
